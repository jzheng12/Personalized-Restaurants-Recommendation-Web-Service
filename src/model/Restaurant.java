...
public class Restaurant {
	...
	/*
	 * public Restaurant(String businessId, String name, String categories,
	 * String city, String state, String fullAddress, double stars, double
	 * latitude, double longitude, String imageUrl, String url) {
	 * 
	 * this.businessId = businessId; this.name = name; this.categories =
	 * categories; this.city = city; this.state = state; this.fullAddress =
	 * fullAddress; this.stars = stars; this.latitude = latitude; this.longitude
	 * = longitude; this.imageUrl = imageUrl; this.url = url; }
	 */
